...
(function ($) {
    ...
    var headerEl = $(".main-header")[0];

    if (headerEl && headerEl.classList) {
        headerEl.classList.forEach(function (className) {
            if (
    ...
    var sidebarEl = $(".main-sidebar")[0];

    if (sidebarEl && sidebarEl.classList) {
        sidebarEl.classList.forEach(function (className) {
    ...
    var brandEl = $(".brand-link")[0];

    if (brandEl && brandEl.classList) {
        brandEl.classList.forEach(function (className) {
            if (
