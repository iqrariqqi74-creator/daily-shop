    ...
    var Sequence = function (element, options) {
        ...
        var Modernizr = (function (a, b, c) {
            ...
            (!B(x, "undefined") && !B(x.call, "undefined")
                ...
                : (y = function (a, b) {
                      return (
                          b in a && B(a.constructor.prototype[b], "undefined")
                      );
                  }),
        ...
        function hasParent(parent, target, previousTarget) {
            ...
            if (parent === target) {
                if (previousTarget !== undefined) {
                    ...
                    var allTopLevel = parent.getElementsByTagName(
                        topLevel.nodeName,
                    );
        ...
        function getHammerDirection(swipeEvents) {
            ...
            if (
                swipeEvents.left !== undefined ||
                swipeEvents.right !== undefined
            ) {
                swipeDirections += 1;
            }

            if (
                swipeEvents.up !== undefined ||
                swipeEvents.down !== undefined
            ) {
                swipeDirections += 2;
            }
        ...
        self.ui = {
            ...
            getElements: function (type, option) {
                ...
                for (i = 0; i < elementsLength; i++) {
                    ...
                    if (
                        rel === null ||
                        rel === self.$container.getAttribute("id")
                    ) {
        ...
        self.autoPlay = {
            ...
            getDelay: function (delay, startDelay, autoPlayInterval) {
                switch (delay) {
                    case true:
                        delay =
                            startDelay === null ? autoPlayInterval : startDelay;
                        break;
        ...
        self.canvas = {
            ...
            getTransformProperties: function () {
                ...
                for (i = 0; i < self.noOfSteps; i++) {
                    ...
                    self.stepProperties[stepId].canvasTransform =
                        canvasTransform;
                }
            },
        ...
        self.animation = {
            ...
            getStepDuration: function (
                ...
                switch (phaseThresholdOption) {
                    ...
                    default:
                        stepDuration =
                            currentPhaseTotal >=
                            nextPhaseTotal + phaseThresholdOption
            ...
            reverseTimingFunction: function (timingFunction) {
                ...
                if (timingFunction.indexOf("cubic-bezier") < 0) {
                    ...
                    // Convert
                    timingFunction =
                        timingFunctionToCubicBezier[timingFunction];
                }
                ...
                if (self.$pagination.elements !== undefined) {
                    ...
                    if (self.$pagination.currentLinks !== undefined) {
                        ...
                        for (i = 0; i < currentPaginationLinksLength; i++) {
                            currentPaginationLink =
                                self.$pagination.currentLinks[i];
                    ...
                    for (j = 0; j < paginationLength; j++) {
                        ...
                        self.$pagination.currentLinks.push(
                            currentPaginationLink,
                        );
                ...
                switch (type) {
                    ...
                    case "hammer":
                        if (
                            ...
                            var handler =
                                self.manageEvents.list.hammer[0].handler;
                    ...
                    handler = addEvent(
                        ...
                        function (e) {
                            ...
                            if (insideElement(self.$container, e) === true) {
                                ...
                                if (
                                    self.options.autoPlayPauseOnHover ===
                                        true &&
                                    self.isMouseOver === false
                                ) {
                                    self.autoPlay.pause();
        ...
        self.goTo = function (id, direction, ignorePhaseThreshold, hashTagNav) {
            ...
            if (
                ...
                (self.options.navigationSkip === false &&
                    self.isAnimating === true) ||
