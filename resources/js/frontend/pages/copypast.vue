        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <p class="hero-description mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
                ...
                <div class="col-lg-6">
                    <div class="hero-image">
                        <img :src="heroImage" alt="Business Growth" class="img-fluid" loading="lazy" />
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature-box">
                        ...
                        <div class="feature-content">
                            ...
                            <p class="feature-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
                ...
                <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
                    <div class="feature-box">
                        ...
                        <div class="feature-content">
                            ...
                            <p class="feature-text">Duis aute irure dolor in reprehenderit in voluptate velit esse
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="feature-box">
                        ...
                        <div class="feature-content">
                            ...
                            <p class="feature-text">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
                    <div class="row gy-4">
                        <div class="col-lg-6">
                            <img :src="aboutPortrait1" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="row gy-4">
                                <div class="col-lg-12">
                                    <img :src="about8" class="img-fluid" alt="">
                                </div>
                                <div class="col-lg-12">
                                    <img :src="about12" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="content">
                            ...
                            <div class="card-body">
                                ...
                                <div class="step-content">
                                    ...
                                    <p>Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec
                                        odio et ante tincidunt.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="content-block">
                        ...
                        <p class="description">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt diam et
                            gravida consequat. Sed nec mauris quis lacus commodo lobortis. Suspendisse euismod commodo
                            sem, in finibus purus bibendum et. Morbi eu neque sed velit convallis vestibulum a vel odio.
                        </p>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                    <div class="cta-image-wrapper">
                        <img :src="cartImage" alt="Call to Action" class="img-fluid rounded-4">
            ...
            <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                ...
                <div class="row g-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                        <div class="portfolio-card">
                            <div class="portfolio-image">
                                <img :src="portfolioImage" class="img-fluid" alt="" loading="lazy">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-actions">
                                        <a :href="portfolioImage" class="glightbox preview-link"
                    ...
                    <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
                        <div class="portfolio-card">
                            <div class="portfolio-image">
                                <img :src="portfolioImage10" class="img-fluid" alt="" loading="lazy">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-actions">
                                        <a :href="portfolioImage10" class="glightbox preview-link"
                    ...
                    <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-motion">
                        <div class="portfolio-card">
                            <div class="portfolio-image">
                                <img :src="portfolioImage7" class="img-fluid" alt="" loading="lazy">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-actions">
                                        <a :href="portfolioImage7" class="glightbox preview-link"
                    ...
                    <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                        <div class="portfolio-card">
                            <div class="portfolio-image">
                                <img :src="portfolioImage2" class="img-fluid" alt="" loading="lazy">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-actions">
                                        <a :href="portfolioImage2" class="glightbox preview-link"
                                            data-gallery="portfolio-gallery-web"><i class="bi bi-eye"></i></a>
                                        <a href="portfolio-details.html" class="details-link"><i
                                                class="bi bi-arrow-right"></i></a>
                                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
                        <div class="portfolio-card">
                            <div class="portfolio-image">
                                <img :src="portfolioImage11" class="img-fluid" alt="" loading="lazy">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-actions">
                                        <a :href="portfolioImage11" class="glightbox preview-link"
                                            data-gallery="portfolio-gallery-graphics"><i class="bi bi-eye"></i></a>
                                        <a href="portfolio-details.html" class="details-link"><i
                                                class="bi bi-arrow-right"></i></a>
                                    </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
                    <div class="team-card">
                        <div class="team-image">
                            <img :src="person3" class="img-fluid" alt="">
                            <div class="team-overlay">
                                <p>Cras ornare tristique elit. Integer in dui quis est placerat ornare...</p>
                                <div class="team-social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                                    <a href=""><i class="bi bi-instagram"></i></a>
                ...
                <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="400">
                    <div class="team-card">
                        <div class="team-image">
                            <img :src="person4" class="img-fluid" alt="">
                            <div class="team-overlay">
...
<script setup>
// Public folder wali image ka static path variable banaya:
const heroImage = '/frontend/assets/img/illustration/illustration-16.webp';
const aboutPortrait1 = '/frontend/assets/img/about/about-portrait-1.webp';
const about8 = '/frontend/assets/img/about/about-8.webp';
const about12 = '/frontend/assets/img/about/about-12.webp';
const person1 = '/frontend/assets/img/person/person-m-1.webp';
const person2 = '/frontend/assets/img/person/person-f-6.webp';
const person3 = '/frontend/assets/img/person/person-m-6.webp';
const person4 = '/frontend/assets/img/person/person-f-3.webp';
const cartImage = '/frontend/assets/img/cta/cta-4.webp';
const portfolioImage = '/frontend/assets/img/portfolio/portfolio-1.webp'
const portfolioImage10 = '/frontend/assets/img/portfolio/portfolio-10.webp'
const portfolioImage7 = '/frontend/assets/img/portfolio/portfolio-7.webp'
const portfolioImage2 = '/frontend/assets/img/portfolio/portfolio-2.webp'
const portfolioImage11 = '/frontend/assets/img/portfolio/portfolio-11.webp'
</script>
