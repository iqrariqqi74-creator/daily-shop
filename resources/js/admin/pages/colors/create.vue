                        ...
                        <div class="card shadow my-5 mx-5 mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <ckeditor :editor="editor" v-model="color.description">
                                                </ckeditor>
                                    ...
                                    <!-- Buttons -->
                                    <div class="mt-3">
                                        <button class="btn btn-success" @click="createColor" :disabled="isLoading">
...
export default {
    ...
    methods: {
        ...
        handleDateValueChange(date, field) {
            if (date) {
                this.color[field] = format(new Date(date), "yyyy-MM-dd HH:mm:ss");
            }
        },
        ...
        async createColor() {
            ...
            try {
                ...
                for (const key in this.color) {
                    if (this.color[key] !== null) {
                        formData.append(key, this.color[key]);
                    }
                }
