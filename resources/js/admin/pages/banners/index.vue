...
export default {
    ...
    data() {
        return {
            ...
            statusFilter: "", // status filter for active/inactive banners
        };
    },
    computed: {
        totalBanners() {
        ...
        activeCount() {
            return this.banners.filter((c) => c.status === "active").length;
        },
        inactiveCount() {
            return this.banners.filter((c) => c.status === "inactive").length;
        },
    },
    methods: {
        getImage(path) {
        ...
        async deleteBanner(banner, index) {
        ...
        viewBanner(banner) {
            this.$router.push(`/admin/banners/${banner.id}/details`);
        },

        async handleBannersSearch() {
            this.params.search = this.searchBanners;
