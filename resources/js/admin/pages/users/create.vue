                        ...
                        <div class="card shadow my-5 mx-5 mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-1">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" v-model="user.name"
                                                    @input="clearErrorMessages('name')" placeholder="Name"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" v-model="user.status"
                                                    ...
                                                    @change="clearErrorMessages('status')">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" v-model="user.password"
                                                    @input="clearErrorMessages('password')" placeholder="password"
                                    ...
                                    <div cols="12">
                                        <button class="btn btn-success" @click="createUser">Save</button>
