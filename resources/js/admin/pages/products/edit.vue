    ...
    methods: {
        ...
        async updateProduct() {
            ...
            try {
                ...
                this.product.productImages.forEach((item, index) => {
                    if (item.id) {
                        formData.append(`productImages[${index}][id]`, item.id);
                    }
        ...
        async fetchProduct() {
            ...
            try {
                ...
                product.productImages = product.product_images.map((img) => ({
                    ...img,
                    preview: IMAGE_URL + img.image,
                }));

                product.productAttribute = product.product_attributes.map(
                    (attr) => ({
                        ...attr,
                        sale_price: attr.maximum_retail_price,
                        image: attr.attribute_image,
                        preview: IMAGE_URL + attr.attribute_image,
                    }),
                );
