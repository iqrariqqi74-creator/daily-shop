                        ...
                        <div class="card shadow my-5 mx-5 mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <ckeditor :editor="editor" v-model="brand.description">
                                                </ckeditor>
                                    ...
                                    <!-- Buttons -->
                                    <div class="mt-3">
                                        <button class="btn btn-success" @click="createBrand" :disabled="isLoading">
...
export default {
    ...
    methods: {
        ...
        handleDateValueChange(date, field) {
            if (date) {
                this.brand[field] = format(new Date(date), "yyyy-MM-dd HH:mm:ss");
            }
        },
